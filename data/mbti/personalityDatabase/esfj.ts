...
export const ESFJData: PersonalityDatabase = {
      career: {
        ...
        superpowers: [
          ...
          },
          {
            ...
            description: "You’re great at keeping things on track, like making sure a project hits every deadline."
          }
        ],
        growthAreas: [
          {
            title: "Saying No",
            description: "You might take on too much to help others—like staying late to cover for a coworker."
          },
          {
            title: "Handling Criticism",
            description: "You might take feedback personally—like feeling down if someone doesn’t love your idea."
          }
        ],
        suggestions: [
          {
            ...
            matchPercentage: 89,
            description: "Your warmth and organizational skills make you a natural at guiding young minds. You’d thrive creating a supportive classroom where everyone feels valued.",
            qualityMatches: [
              {
                title: "Nurturing",
              ...
              {
                title: "Structure",
                description: "You keep lessons on track with your planning prowess."
              }
            ]
          },
          {
            title: "Event Planner",
            matchPercentage: 87,
            description: "Bringing people together for memorable moments is your forte. You’d shine coordinating details and ensuring everyone has a great time.",
            qualityMatches: [
              {
                title: "People Skills",
                description: "Your ability to connect makes events warm and welcoming."
              },
              {
                title: "Detail-Oriented",
                description: "You nail every logistical piece for a flawless execution."
              }
            ]
          },
          {
            ...
            matchPercentage: 85,
            description: "Supporting employees and fostering a positive workplace culture is right up your alley. You’d excel at resolving conflicts and boosting team morale.",
            qualityMatches: [
              {
                title: "Empathy",
                description: "You understand and address people’s needs effectively."
              },
              {
                title: "Organization",
                description: "You manage processes smoothly to keep things fair and efficient."
              }
            ]
          }
        ],
        actionSteps: [
          {
            number: 1,
            description: "Practice saying “no” once this week—like “I’d love to help, but I’m swamped right now.”"
          },
          {
            number: 2,
          ...
          {
            number: 3,
            description: "Look for jobs that let you care for others, like being a teacher or a community organizer—your kind of vibe!"
          }
        ]
      },
      relationships: [
        {
          ...
          superpowers: [
            ...
            },
            {
              ...
              description: "You’re great at keeping the peace, like smoothing over a disagreement in the family."
            }
          ],
          growthAreas: [
            {
              title: "Taking Time for Yourself",
              description: "You might put others first—like skipping your own plans to help a friend."
            },
            {
              title: "Letting Go of Small Stuff",
              description: "You might worry too much about little things—like stressing if a plan doesn’t go perfectly."
            }
          ],
          actionSteps: [
            {
              number: 1,
              description: "Schedule a solo evening this week—like watching your favorite show with a cozy blanket—to recharge."
            },
            {
              number: 2,
              description: "If you’re overthinking something, ask yourself, “Will this matter in a week?”—it’ll help you let go."
            },
            {
              number: 3,
        ...
        },
        {
          ...
          superpowers: [
            ...
            },
            {
              ...
              description: "You make the best memories, like organizing a game night with all their favorite snacks."
            }
          ],
          growthAreas: [
            {
              title: "Speaking Up",
              description: "You might not always share your own needs—like keeping quiet when you’re feeling overwhelmed."
            },
            {
              title: "Trying New Things",
              description: "You might stick to what’s familiar—like always hosting at your place instead of trying a new spot."
            }
          ],
          actionSteps: [
            {
              number: 1,
              description: "Open up to a friend this month about something you’re going through—like “I’ve been feeling a bit stressed lately.”"
            },
            {
              number: 2,
              description: "Plan a new kind of hangout, like a picnic in the park, to mix things up with your crew."
            }
          ]
        }
      ],
      growth: {
        ...
        superpowers: [
          ...
          },
          {
            ...
            description: "You approach growth with a practical mindset, keeping it real and doable."
          }
        ],
        growthAreas: [
          {
            title: "Putting Yourself First",
            description: "You might put others’ needs before your own—like skipping a break to help a friend."
          },
          {
            title: "Embracing Change",
            description: "New situations can feel tricky—like trying a new hobby that’s out of your comfort zone."
          }
        ],
        actionSteps: [
          {
            number: 1,
            description: "Take 10 minutes each day just for you—like sipping coffee while listening to your favorite podcast."
          },
          {
            number: 2,
            description: "Try one new thing this week, like joining a dance class or trying a new recipe—it’ll feel exciting!"
          },
          {
            number: 3,
      ...
      dailyHabits: {
        ...
        habits: {
          morning: {
            ...
            description: "Start your morning with a 5-minute gratitude list—like writing down three things you’re thankful for today."
          },
          afternoon: {
            title: "Cozy Habit",
            description: "Add a small, cozy habit—like lighting a candle while you plan your day—to make your morning feel extra nice."
          },
          evening: {
            title: "Connect",
            description: "Wind down with a 10-minute habit, like texting a friend to say goodnight, to relax before bed."
          }
        },
        communication: {
      ...
      valuesAndMotivators: {
        ...
        coreValues: [
          {
            title: "Connection",
            description: "You cherish bringing people together and fostering bonds."
          },
          {
            title: "Kindness",
