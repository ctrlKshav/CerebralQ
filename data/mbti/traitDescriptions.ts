...
export const personalityTraitDescriptions: Record<string, TraitDescriptions> = {
  INTJ: {
    "E-I": {
      ...
      description:
        "Where you get your energy. Extraverts thrive in social settings and feel energized around others. Introverts need alone time to recharge and often do their best thinking in solitude.",
      left: {
        letter: "E",
        name: "Extraversion",
        description:
    ...
    "S-N": {
      ...
      description:
        "How you take in the world. Sensing types trust what they can see, touch, and directly experience. Intuitive types read between the lines, spotting patterns and possibilities others might miss.",
      left: {
        letter: "S",
        name: "Sensing",
        description:
    ...
    "T-F": {
      ...
      description:
        "How you make choices. Thinking types analyze problems logically and value fairness through consistency. Feeling types consider emotional impact and strive for harmony in their decisions.",
      left: {
        letter: "T",
        name: "Thinking",
        description:
    ...
    "J-P": {
      ...
      description:
        "How you structure your life. Judging types crave order, plans, and closure. Perceiving types prefer staying flexible, adapting on the fly, and keeping their options open.",
      left: {
        letter: "J",
        name: "Judging",
        description:
