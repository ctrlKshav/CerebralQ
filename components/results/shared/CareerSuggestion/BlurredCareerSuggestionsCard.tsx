...
const sampleCareerData: CareerSuggestion[] = [
  {
    ...
    matchPercentage: 92,
    description:
      "Coordinate business operations by organizing teams, resources, and processes to achieve organizational goals.",
    qualityMatches: [
      {
        title: "Strategic Thinking",
        description:
          "Your ability to think ahead and plan strategically makes you an effective business manager.",
      },
      {
        title: "Leadership",
        description:
          "Your natural leadership qualities help you guide teams toward success.",
      },
      {
        title: "Pragmatism",
        description:
          "Your practical approach helps keep business operations grounded and focused on results.",
      },
    ],
  },
  {
    ...
    matchPercentage: 89,
    description:
      "Create and operate your own business ventures, identifying opportunities and taking calculated risks.",
    qualityMatches: [
      {
        title: "Independence",
        description:
          "Your self-directed nature allows you to forge your own path in business.",
      },
      {
        title: "Vision",
        description:
          "Your ability to see possibilities helps you identify unique business opportunities.",
      },
      {
        title: "Resilience",
        description:
          "Your adaptability helps you navigate the challenges of entrepreneurship.",
      },
    ],
  },
  {
    ...
    matchPercentage: 85,
    description:
      "Practice, interpret and apply legal principles in various contexts, from advocacy to advisory roles.",
    qualityMatches: [
      {
        title: "Critical Thinking",
        description:
          "Your analytical skills help you evaluate complex legal arguments effectively.",
      },
      {
        title: "Persuasiveness",
        description:
          "Your communication skills enable you to advocate convincingly for clients.",
      },
      {
        title: "Attention to Detail",
        description:
          "Your methodical approach ensures thoroughness in legal documentation and research.",
      },
    ],
  },
  {
    ...
    matchPercentage: 82,
    description:
      "Design and develop innovative solutions to technical problems across various industries.",
    qualityMatches: [
      {
        title: "Problem-Solving",
        description:
          "Your methodical approach to challenges makes you an effective engineer.",
      },
      {
        title: "Analytical Thinking",
        description:
          "Your ability to break down complex systems helps in engineering design.",
      },
      {
        title: "Innovation",
        description:
          "Your creative thinking helps develop novel solutions to technical problems.",
      },
    ],
  },
];
