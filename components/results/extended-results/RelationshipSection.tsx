...
const RelationshipSection = ({ data, sectionNumber = 4 }: RelationshipSectionProps) => {
  ...
  return (
    <section className="py-20 px-4 sm:px-8 lg:px-16 relative overflow-hidden bg-gray-50">
      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        >
          <div className="flex flex-col items-center justify-center mb-10">
            {/* Tab triggers */}
            <TabsList className="grid grid-cols-2 w-full h-full max-w-lg bg-gray-100/80 p-1 rounded-lg">
              {relationships.map((rel) => (
                <TabsTrigger 
                  key={rel.type} 
                  value={rel.type}
                  className="flex items-center justify-center gap-2 py-3 px-6 text-base font-medium rounded-md transition-all data-[state=active]:bg-mbti-purple data-[state=active]:text-white data-[state=inactive]:bg-transparent data-[state=inactive]:text-gray-700 hover:text-mbti-purple/90"
                >
            ...
            <div className="mt-5 flex flex-wrap items-center justify-center gap-2">
              ...
              <div className="flex flex-wrap gap-2 justify-center">
                {relationships.find(r => r.type === activeTab)?.compatibleTypes.map((type) => (
                  <Badge key={type} className="bg-mbti-purple/10 hover:bg-mbti-purple/20 text-mbti-purple px-3 py-1">
                    {type}
                  </Badge>
                ))}
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-16">
                ...
                <div className="glass-card rounded-xl p-8 h-full">
                  <div className="flex items-center mb-6">
                    <div className="rounded-full bg-gradient-to-br from-emerald-400 to-teal-600 p-3 mr-4 shadow-lg">
                    ...
                    {relationship.type === "Romantic" ? (
                      <>
                        <li className="flex items-start">
                          ...
                          <div>
                            <p className="font-medium text-lg mb-1">Being Motivational:</p>
                            <p className="text-gray-700">You lift people up, {username}—like cheering on a partner to go after a big opportunity.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <CheckCircle className="h-6 w-6 text-emerald-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Taking Charge:</p>
                            <p className="text-gray-700">You make things happen, like planning a memorable anniversary dinner for your partner.</p>
                          </div>
                        </li>
                      </>
                      ...
                      <>
                        <li className="flex items-start">
                          <CheckCircle className="h-6 w-6 text-emerald-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Being Inspiring:</p>
                            <p className="text-gray-700">Your friends look up to you, {username}—like when you motivate them to join a charity run.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <CheckCircle className="h-6 w-6 text-emerald-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Planning Big Moments:</p>
                            <p className="text-gray-700">You create awesome experiences, like organizing a group trip everyone talks about for years.</p>
                          </div>
                        </li>
                      </>
                    ) : (
                      <>
                        <li className="flex items-start">
                          <CheckCircle className="h-6 w-6 text-emerald-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Natural Leadership:</p>
                            <p className="text-gray-700">You excel at taking charge, {username}—like confidently leading a team through a challenging project.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <CheckCircle className="h-6 w-6 text-emerald-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Strategic Thinking:</p>
                            <p className="text-gray-700">You're excellent at seeing the big picture and creating plans to reach ambitious goals.</p>
                          </div>
                        </li>
                      </>
                    )}
                ...
                <div className="glass-card rounded-xl p-8 h-full">
                  <div className="flex items-center mb-6">
                    <div className="rounded-full bg-gradient-to-br from-amber-400 to-orange-500 p-3 mr-4 shadow-lg">
                    ...
                    {relationship.type === "Romantic" ? (
                      <>
                        <li className="flex items-start">
                          ...
                          <div>
                            <p className="font-medium text-lg mb-1">Being Vulnerable:</p>
                            <p className="text-gray-700">You might focus on goals and miss the emotions—like not sharing when you're feeling stressed.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full border-2 border-amber-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Slowing Down:</p>
                            <p className="text-gray-700">You might push too hard—like encouraging a loved one to act before they're ready.</p>
                          </div>
                        </li>
                      </>
                    ) : relationship.type === "Friendship" ? (
                      <>
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full border-2 border-amber-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Listening More:</p>
                            <p className="text-gray-700">You might focus on your ideas—like not hearing a friend's quieter suggestion during a group plan.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full border-2 border-amber-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Being Flexible:</p>
                            <p className="text-gray-700">You might stick to your vision—like pushing for a plan when your friends want to do something else.</p>
                          </div>
                        </li>
                      </>
                    ) : (
                      <>
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full border-2 border-amber-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Delegating Effectively:</p>
                            <p className="text-gray-700">You might take on too much—like handling tasks yourself instead of trusting team members with responsibilities.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <div className="h-6 w-6 rounded-full border-2 border-amber-500 mr-3 flex-shrink-0 mt-1" />
                          <div>
                            <p className="font-medium text-lg mb-1">Patience with Process:</p>
                            <p className="text-gray-700">You might rush toward results—like skipping important steps when you're excited about a project.</p>
                          </div>
                        </li>
                      </>
                    )}
                    ...
                    <ul className="space-y-6">
                      {relationship.type === "Romantic" ? (
                        <>
                          ...
                          <li className="flex items-start">
                            <div className="h-8 w-8 rounded-full bg-mbti-purple text-white text-base grid place-items-center mr-4 mt-1 flex-shrink-0">3</div>
                            <p className="text-gray-600 text-base md:text-lg">
