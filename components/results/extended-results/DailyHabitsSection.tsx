  ...
  return (
    <section className="py-20 px-4 sm:px-8 lg:px-16 relative overflow-hidden bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-[1800px] mx-auto">
            ...
            <div className="p-8 lg:w-3/5">
              ...
              <ul className="space-y-6 ml-4">
                <li className="flex items-start">
                  <div className="flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-yellow-400 to-amber-500 text-white mr-4 flex-shrink-0 shadow-md">
                    <Sun className="h-5 w-5" strokeWidth={2} />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg text-gray-800 mb-2">Morning Routine</h4>
                ...
                <li className="flex items-start">
                  <div className="flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white mr-4 flex-shrink-0 shadow-md">
                    <Clock className="h-5 w-5" strokeWidth={2} />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg text-gray-800 mb-2">During the Day</h4>
                    <p className="text-gray-700 text-base md:text-lg">
                ...
                <li className="flex items-start">
                  <div className="flex items-center justify-center h-10 w-10 rounded-full bg-gradient-to-r from-indigo-400 to-mbti-purple text-white mr-4 flex-shrink-0 shadow-md">
                    <Moon className="h-5 w-5" strokeWidth={2} />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg text-gray-800 mb-2">Evening Wind-down</h4>
                    <p className="text-gray-700 text-base md:text-lg">
        ...
        <div className="glass-card rounded-xl p-0 mb-16 overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            <div className="p-8 lg:w-3/5">
              ...
              <p className="text-gray-700 text-base md:text-lg mb-6 ml-2">
              ...
              <div className="ml-2 space-y-5">
                <h4 className="font-medium text-lg text-gray-800 mb-3 flex items-center">
                  <CheckCircle className="h-5 w-5 text-indigo-500 mr-2" /> Let's Make It Happen:
                </h4>
                <div className="flex items-start ml-4">
                  <div className="h-8 w-8 rounded-full bg-blue-500 text-white text-base grid place-items-center mr-4 mt-1 flex-shrink-0">1</div>
                  <p className="text-gray-700 text-base md:text-lg">
                    Add a warm touch to your conversations—like starting with "I'm really excited to hear your thoughts on this!"
                  </p>
                </div>
                <div className="flex items-start ml-4">
                  <div className="h-8 w-8 rounded-full bg-blue-500 text-white text-base grid place-items-center mr-4 mt-1 flex-shrink-0">2</div>
                  <p className="text-gray-700 text-base md:text-lg">
        ...
        {/* Reflection Prompts Section - Fix icon alignment */}
        <div className="mb-16">
          <div className="text-center mb-12">
            <div className="flex items-center justify-center mb-5">
              <div className="bg-gradient-to-r from-purple-500 to-pink-500 p-3 rounded-full shadow-lg">
                <PenTool className="h-6 w-6 text-white drop-shadow-sm" strokeWidth={2} />
              </div>
              <h3 className="text-xl md:text-2xl font-bold text-gray-800 ml-4">
                Reflection Prompts
              </h3>
            </div>
          ...
          <div className="grid grid-cols-1 gap-8">
            {growth.journalingPrompts.map((prompt, index) => {
              ...
              const colorSchemes = [
                {
                  ...
                  icon: <Edit3 className="h-6 w-6 text-white" strokeWidth={2} />,
                  accent: "border-purple-200 focus:ring-purple-400/50"
                },
                {
                  bg: "bg-gradient-to-r from-amber-500 to-orange-500",
                  icon: <Target className="h-6 w-6 text-white" strokeWidth={2} />,
                ...
                },
                {
                  ...
                  icon: <MessageSquare className="h-6 w-6 text-white" strokeWidth={2} />,
              ...
              return (
                <div 
                  key={index} 
                  className="glass-card border border-gray-100 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all"
                >
                  <div className="grid lg:grid-cols-2 h-full">
                    <div className="p-8 bg-gradient-to-br from-gray-50 to-white flex flex-col justify-center">
                      <div className="flex items-start">
                        ...
                        <div className="ml-4">
                          <div className="inline-block px-2 py-1 bg-gray-100 rounded-full text-xs font-semibold text-gray-700 mb-2">
                            Prompt {index + 1}
                          </div>
                          <h4 className="font-bold text-lg text-gray-800">{prompt.question}</h4>
                          <p className="text-gray-600 mt-2 italic font-medium text-sm">{prompt.hint}</p>
                        </div>
                      </div>
                    </div>
                    
                    <div className="p-8 bg-white border-l border-gray-100">
                      <h5 className="font-medium text-base text-gray-700 mb-3 flex items-center">
                        <PenTool className="h-5 w-5 mr-2 text-gray-500" />
                        Your Thoughts
                      </h5>
                      <Textarea 
                        className={`w-full p-3 rounded-lg border-2 ${scheme.accent} focus:outline-none focus:ring-2 focus:border-transparent min-h-[180px] bg-gray-50 text-sm md:text-base`}
