...
const TestOverviewSection = () => {
  ...
  return (
    <section className="py-20 md:py-28 bg-background dark:bg-background" id="overview" ref={sectionRef}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          <div className="mb-8">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6 relative inline-block">
              What is the <span className="relative z-10 text-primary">OCEAN</span> Test?
              <div className="absolute bottom-0 left-0 right-0 h-3 bg-primary/20 -rotate-1 transform translate-y-2 z-0"></div>
            </h2>
            
            <p className="text-muted-foreground text-lg max-w-3xl mx-auto">
              OCEAN stands for <strong>O</strong>penness, <strong>C</strong>onscientiousness, <strong>E</strong>xtraversion, <strong>A</strong>greeableness, and <strong>N</strong>euroticism – the five dimensions that form the foundation of your personality.
            </p>
          </div>
        </div>
        ...
        <div className="bg-card rounded-3xl p-8 md:p-12 mb-14 shadow-lg relative overflow-hidden max-w-4xl mx-auto border border-muted">
          ...
          <div className="relative z-10">
            <p className="text-card-foreground text-lg md:text-xl leading-relaxed">
              Based on the scientifically-validated <span className="font-semibold">Five Factor Model</span>, the OCEAN Test measures the core dimensions of your personality through carefully designed questions. Used by psychologists worldwide, this model reveals your natural tendencies, strengths, and potential areas for growth.
            </p>
            ...
            <div className="mt-6 relative pl-6 border-l-4 border-primary/50">
              ...
              <p className="text-card-foreground/90 font-medium">
                Understand yourself with the same framework used by leading researchers and psychologists for decades.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl shadow-lg border border-muted overflow-hidden max-w-4xl mx-auto">
          <div className="p-6 border-b border-muted">
            <h3 className="text-xl font-bold text-card-foreground mb-2">Test Details</h3>
            <p className="text-muted-foreground">Everything you need to know before taking the test</p>
          </div>
          ...
          <div className="p-6 flex flex-wrap gap-4 border-b border-muted">
            {[
              ...
              >
                <span className={`flex items-center justify-center w-5 h-5 ${badge.iconBgClass} rounded-full`}>
                  {badge.icon}
                </span>
          ...
          {/* Benefits list */}
          <div className="p-6">
            <h4 className="font-medium text-card-foreground mb-4">What You'll Get:</h4>
