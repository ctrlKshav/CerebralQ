...
const TestOverviewSection = () => {
  ...
  return (
    ...
    >
      <SectionHeader
        badge="Overview"
        title="What is the HEXACO Assessment?"
        highlightWord="HEXACO"
        description="HEXACO stands for Honesty-Humility, Emotionality, eXtraversion, Agreeableness, Conscientiousness, and Openness to Experience—six dimensions that provide a comprehensive view of your personality."
      />
        ...
        <div className="bg-card rounded-3xl p-8 md:p-12 shadow-lg relative overflow-hidden max-w-4xl mx-auto border border-muted">
          ...
          <div className="relative z-10">
            <p className="text-card-foreground text-lg md:text-xl leading-relaxed">
              Developed by personality researchers Michael Ashton and Kibeom Lee, the{" "}
              <span className="font-semibold">HEXACO model</span> extends beyond traditional five-factor models by adding the crucial{" "}
              <span className="font-semibold">Honesty-Humility</span> dimension—capturing ethical aspects of personality that other assessments miss.
            </p>
            ...
            <div className="mt-6 relative pl-6 border-l-4 border-primary/50">
              <p className="text-card-foreground/90 font-medium">
                The HEXACO model provides a more complete picture of personality, with particular strength in predicting integrity, ethical behavior, and interpersonal relations.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {[
                ...
                "Detailed analysis of 24 personality facets",
                "Insights into ethical and integrity aspects",
                "Understanding of emotional responses",
                "Social interaction style assessment",
                "Work style and organization insights",
                "Creativity and unconventionality measures",
