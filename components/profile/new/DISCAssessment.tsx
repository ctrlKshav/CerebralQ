      ...
      <div className="space-y-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-start bg-white dark:bg-gray-800 rounded-xl p-8 border border-gray-200 dark:border-gray-700">
          <div className="w-full md:w-2/5 flex flex-col">
            ...
            <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-1 text-center md:text-left">
              {result.type}
            </h3>
            <h4 className="text-lg text-cyan-700 dark:text-cyan-400 mb-4 text-center md:text-left">
              {result.title}
            </h4>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
          <h3 className="text-xl font-semibold mb-5 text-cyan-700 dark:text-cyan-400">
            DISC Factors
          </h3>
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-base font-medium text-blue-600 dark:text-blue-400">
                  {result.factors.dominance}%
                </span>
              </div>
              <div className="h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-blue-500 rounded-full"
                  style={{ width: `${result.factors.dominance}%` }}
                ></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-base font-medium text-yellow-600 dark:text-yellow-400">
                  {result.factors.influence}%
                </span>
              </div>
              <div className="h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-yellow-500 rounded-full"
                  style={{ width: `${result.factors.influence}%` }}
                ></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-base font-medium text-green-600 dark:text-green-400">
                  {result.factors.steadiness}%
                </span>
              </div>
              <div className="h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-green-500 rounded-full"
                  style={{ width: `${result.factors.steadiness}%` }}
                ></div>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between mb-2">
                ...
                <span className="text-base font-medium text-purple-600 dark:text-purple-400">
                  {result.factors.conscientiousness}%
                </span>
              </div>
              <div className="h-3 bg-gray-100 dark:bg-gray-700 rounded-full overflow-hidden">
                <div
                  className="h-full bg-purple-500 rounded-full"
                  style={{ width: `${result.factors.conscientiousness}%` }}
                ></div>
              </div>
            </div>
          </div>
