...
import { UserType, ProficiencyLevel, TestResultSummary } from "@/types/profileTypes";
...
export default function ProfileHeader({
  ...
  return (
    <section className="bg-white dark:bg-gray-800 rounded-xl shadow-md mb-16 p-8 md:p-10">
      <div className="flex flex-col gap-12 items-start">
        ...
        <div className="flex flex-col md:flex-row w-full gap-8 md:gap-16 items-center md:items-start">
          <div className="flex flex-col items-center md:items-start max-w-md">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Button
                className="rounded-lg px-6 py-2 h-auto bg-primary hover:bg-primary/90"
              >
        ...
        <div className="w-full border-t border-gray-200 dark:border-gray-700 pt-8">
          <BadgeDisplay 
            proficiencyLevel={proficiencyLevel} 
