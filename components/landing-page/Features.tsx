  ...
  return (
    <section className="relative py-24 px-6 bg-secondary/50 dark:bg-secondary/20 overflow-hidden">
      ...
      <div className="container mx-auto max-w-6xl">
        ...
        >
          <div className="inline-flex items-center px-3 py-1 rounded-full bg-primary/10 border border-primary/20 backdrop-blur-sm mb-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Explore the powerful tools and visualizations that make Cerebral Quotient the premier personality assessment platform.
          </p>
        </motion.div>
                    ...
                    >
                      {feature.id === 'reports' && (
                        <>
                          <li className="flex items-center gap-2">
                            ...
                            <span className="text-sm">In-depth trait analysis</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                          ...
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">PDF export functionality</span>
                          </li>
                        </>
                      )}
                      ...
                      {feature.id === 'dashboard' && (
                        <>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Interactive trait visualizations</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Comparative analysis tools</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Personalized insights feed</span>
                          </li>
                        </>
                      )}
                      ...
                      {feature.id === 'share' && (
                        <>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">One-click social sharing</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Custom share privacy settings</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Embeddable personality cards</span>
                          </li>
                        </>
                      )}
                      ...
                      {feature.id === 'progress' && (
                        <>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Track changes over time</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                            <span className="text-sm">Goal-setting functionality</span>
                          </li>
                          <li className="flex items-center gap-2">
                            <div className="h-1.5 w-1.5 rounded-full bg-primary"></div>
                ...
                <div className="w-full h-full relative">
                  ...
                  <svg width="100%" height="100%" viewBox="0 0 200 200">
                    ...
                    <motion.circle
                      ...
                      cx="100" cy="60" r="4" fill="rgba(124, 58, 237, 1)"
                    />
                    <motion.circle
                      initial={{ scale: 0, opacity: 0 }}
                      animate={{ scale: 1, opacity: 1 }}
                      transition={{ duration: 0.3, delay: 1.1 }}
                      cx="140" cy="90" r="4" fill="rgba(124, 58, 237, 1)"
                    />
                    <motion.circle
                      initial={{ scale: 0, opacity: 0 }}
                      animate={{ scale: 1, opacity: 1 }}
                      transition={{ duration: 0.3, delay: 1.2 }}
                      cx="125" cy="140" r="4" fill="rgba(124, 58, 237, 1)"
                    />
                    <motion.circle
                      initial={{ scale: 0, opacity: 0 }}
                      animate={{ scale: 1, opacity: 1 }}
                      transition={{ duration: 0.3, delay: 1.3 }}
                      cx="75" cy="140" r="4" fill="rgba(124, 58, 237, 1)"
                    />
                    <motion.circle
                      initial={{ scale: 0, opacity: 0 }}
                      animate={{ scale: 1, opacity: 1 }}
                      transition={{ duration: 0.3, delay: 1.4 }}
                      cx="60" cy="90" r="4" fill="rgba(124, 58, 237, 1)"
                    />
                    
                    {/* Labels */}
                    <text x="100" y="20" textAnchor="middle" fill="currentColor" fontSize="8">Openness</text>
                    <text x="190" y="75" textAnchor="end" fill="currentColor" fontSize="8">Conscientiousness</text>
                    <text x="155" y="185" textAnchor="middle" fill="currentColor" fontSize="8">Extraversion</text>
                    <text x="45" y="185" textAnchor="middle" fill="currentColor" fontSize="8">Agreeableness</text>
                    <text x="10" y="75" textAnchor="start" fill="currentColor" fontSize="8">Neuroticism</text>
                  </svg>
                </div>
              </div>
            </div>
    ...
    case 'progress':
      return (
        ...
        >
          ...
          <div className="space-y-4">
            <div className="text-sm font-medium text-muted-foreground mb-2">Progress Over Time</div>
            ...
            >
              <svg width="100%" height="100%" viewBox="0 0 300 120" preserveAspectRatio="none">
                {/* Grid lines */}
                <line x1="0" y1="0" x2="300" y2="0" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="0" y1="30" x2="300" y2="30" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="0" y1="60" x2="300" y2="60" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="0" y1="90" x2="300" y2="90" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="0" y1="120" x2="300" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                
                <line x1="0" y1="0" x2="0" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="60" y1="0" x2="60" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="120" y1="0" x2="120" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="180" y1="0" x2="180" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="240" y1="0" x2="240" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                <line x1="300" y1="0" x2="300" y2="120" stroke="currentColor" strokeWidth="0.5" strokeOpacity="0.1" />
                ...
                {/* Data points */}
                {[
                  { x: 0, y: 100 }, { x: 60, y: 90 }, { x: 120, y: 70 }, { x: 180, y: 40 }, { x: 240, y: 30 }, { x: 300, y: 20 },
                  { x: 0, y: 80 }, { x: 60, y: 90 }, { x: 120, y: 85 }, { x: 180, y: 60 }, { x: 240, y: 50 }, { x: 300, y: 55 },
                ].map((point, index) => (
                  <motion.circle 
                    key={index}
                    initial={{ scale: 0, opacity: 0 }}
                    ...
                    cy={point.y} 
                    r="3" 
                    fill={index < 6 ? "rgba(124, 58, 237, 0.8)" : "rgba(124, 58, 237, 0.4)"}
                  />
                ))}
              </svg>
            </motion.div>
